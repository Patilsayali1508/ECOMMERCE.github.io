...
<!--      <div class="w-full mb-2 md:w-1/2 md:mx-4 border  shadow-lg"> -->
  ...
  <div class="px-4 mb-4">
   <!-- <form action="add_to_cart" method="POST">-->
      ...
      <a href={{"Removecartitem/".$item->id}} onclick="return confirm('Are you sure?')" class="text-lg px-4 py-1 text-white transition-all duration-150 ease-linear rounded-lg shadow outline-none  bg-purple-600 hover:bg-pink-600 hover:shadow-lg focus:outline-none"><i class="mdi mdi-delete-outline text-xl"></i>Remove</a>
    <!--</form>-->
